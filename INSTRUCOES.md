...
> ℹ️ Pelo SQL Editor, rode **na ordem**: primeiro `0001_init_schema.sql` (cria as tabelas) e depois `0002_rename_tables_livia_fiorelli.sql` (aplica o prefixo `livia_fiorelli_`).
